...
void VsHuman()
{
    ...
    //getting input from the player1 who will enter the word to be guessed by player 2
    ...
    //hiding the input of player1 and printing underscores of the length of the word
    ...
    if(choice!='\0' && choice>=48 && choice<=57){
        switch(choice){
            ...
            case '3':{
                ...
                " and the other tries to guess it by suggesting letters. Each incorrect guess "
                "results in a part of a stick-figure being drawn, representing a person being "
                "\"hanged.\" The game ends when the word is guessed correctly or the drawing "
